...
describe('url-validator utilities', () => {
  ...
  it('detects blocked domain and private IPs', () => {
  ...
  it('validateUrlOrThrow throws on invalid', () => {
    expect(() => validateUrlOrThrow('://bad')).toThrow();
  });

  it('validateMultipleUrls and areAllUrlsValid', () => {
  ...
  it('extractBaseDomain returns hostname', () => {
